...
A SQL-driven business analysis of approx. 100k real orders from [Olist](https://olist.com), a Brazilian
...
|---|---|---|---|
| [1](queries/01_revenue_by_month.sql) | How is revenue trending month over month? | Steady growth through 2017, sharp Black Friday spike in **Nov 2017** (approx. $988K, 7,289 orders), then a 2018 plateau (approx. $850K-975K/month). AOV stayed flat (approx. $125-150). | **Growth was driven by order volume, not bigger baskets** — customer acquisition, not upsell, was the growth engine. |
...
| [4](queries/04_delivery_performance.sql) | How long does delivery take, and how often is it late? | Average delivery time: **12.5 days**. **8.1% of orders arrive late**, averaging **approx. 8.9 days late** when they are. | Lateness isn't a marginal miss — it's a substantial, approx. 9-day delay, which sets up finding #5. |
